...
using System.Runtime.ConstrainedExecution;  //for SafePhysicalMonitorHandle class
using Microsoft.Win32.SafeHandles;                  //for SafePhysicalMonitorHandle class
...
namespace ModuleLayer
{
    ...
    public class SafePhysicalMonitorHandle : SafeHandleMinusOneIsInvalid
    {
        ...
        public SafePhysicalMonitorHandle(IntPtr handle) : base(true)
        {
            this.handle = handle;
        }
