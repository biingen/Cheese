...
namespace Universal_Toolkit
{
    public class FTDI_Lib
    {
        ...
        public FtResult I2C_SEQ_Read(IntPtr FtHandle, byte DeviceAddr, byte[] W_Data, byte[] R_Data, out byte RDataLength)
        {
            ...
            Thread.Sleep(500);
            FtStatus = I2C_DeviceRead(FtHandle, (byte)(DeviceAddr >> 1), 128, buffer, out ByteTransferred, FtI2cTransferOptions.START_BIT | FtI2cTransferOptions.NACK_LAST_BYTE);
            ...
            else
            {
                ...
                Log.Info("Read - incorrect length of return byte!");
